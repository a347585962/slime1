...
import ColorRect = require('./utils/ColorRectCE');
import { CocosHelper } from './utils/CocosHelperCE';
import ShaderTime from './effect/ShaderTimeCE';
import ShaderHelper from './effect/ShaderHelperCE';
