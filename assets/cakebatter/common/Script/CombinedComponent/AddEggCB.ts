import NodeComp = require('../codebase/utils/NodeCompCB');
import NodeTransform from '../codebase/utils/NodeTransformCB';
import SpriteDrag from '../codebase/SpriteDrag/SpriteDragCB';
import DragEventListener, { DragEventType } from '../codebase/SpriteDrag/DragEventListenerCB';
import { CocosHelper } from '../codebase/utils/CocosHelperCB';
import EventListener from '../codebase/EventListenerCB';
// Learn TypeScript:
...
export default class AddEgg extends cc.Component {
    ...
    showBreakAction(){
        ...
        .call(()=>{this.breakNode.active = false;this.fallNode.active = true;})
        .delay(0.3)
        .call(()=>{
            this.fallNode.active = false;
            if(this.eggInBowl){
