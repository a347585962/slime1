...
import ColorRect = require('./utils/ColorRectFS');
import { CocosHelper } from './utils/CocosHelperFS';
import ShaderTime from './effect/ShaderTimeFS';
import ShaderHelper from './effect/ShaderHelperFS';
