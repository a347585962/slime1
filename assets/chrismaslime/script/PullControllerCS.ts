...
import DragonCompoent from "./DragonCompoentCS";
import TransitionScene from "../common/Script/codebase/TransitionSceneCS";
import showLaoding from "../common/Script/showLaodingCS";
...
export default class PullController extends cc.Component {
    ...
    start () {
        ...
        btn_next.zIndex = 100;
        if (cc.director.getScene().name == 'pullSlime0CS') {
            this.maxCount = 4;
            this.time = 2;
        } else {
            this.maxCount = 2;
    ...
    touchNextBtn() {
        ...
        if (cc.director.getScene().name == 'pullSlime0CS') {
            showLaoding.getInstance().loadingDoneCallback = function () { 
                ...
                TransitionScene.changeScene('pourSnowCS');
                
            }
            showLaoding.getInstance().showAds(false);
           
        } else {
            TransitionScene.changeScene('coilSlimeCS');
        }
