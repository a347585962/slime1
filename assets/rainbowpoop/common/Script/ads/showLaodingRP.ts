import AdsManager, { ADS_TYPE } from "./AdsManagerRP";
...
export default class showLaoding {
    ...
    showAds(androidLoading:string,iosLoading:string,isCross : boolean):void{
        ...
        if(cc.sys.platform == cc.sys.ANDROID){
            console.log(androidLoading)
            cc.loader.loadRes(androidLoading, onResourceLoaded);
        } else {
            console.log(iosLoading)
            cc.loader.loadRes(iosLoading, onResourceLoaded);
        }
    }
