...
export   class CocosHelper {
    ...
    static getScreenPos(_node:cc.Node,_dir:CocosHelper.ShowDirection):cc.Vec2{
        ...
        if(_mainC != null){
            topLeft = cc.v2(_mainC.getScreenToWorldPoint(topLeft,new cc.Vec2()).x, _mainC.getScreenToWorldPoint(topLeft,new cc.Vec2()).y);
            bottomRight = cc.v2(_mainC.getScreenToWorldPoint(bottomRight,new cc.Vec2()).x, _mainC.getScreenToWorldPoint(bottomRight,new cc.Vec2()).y);
        }
...
*/
  static  captureNode(distNode:cc.Node) {
    ...
    static  captureNode3(distNode:cc.Node, width, height) {
    ...
    static saveImageByNode(distNode: cc.Node, name:string,callback:Function){
        CocosHelper.captureNodeSize(distNode,640,960).then((texture:cc.RenderTexture)=>{
