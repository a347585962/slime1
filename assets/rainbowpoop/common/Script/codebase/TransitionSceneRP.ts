...
import ColorRect = require('./utils/ColorRectRP');
import { CocosHelper } from './utils/CocosHelperRP';
import ShaderTime from './effect/ShaderTimeRP';
import ShaderHelper from './effect/ShaderHelperRP';
